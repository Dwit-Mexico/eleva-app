			...
			{view == 'camara'?
				<Container>
					...
					<View style={{flex: 0.1, justifyContent: 'center', alignItems: 'center'}}>
						<TouchableOpacity onPress={_tomarFoto.bind(this)} style={{backgroundColor: 'white', padding: 6, borderRadius: 50, width: 50, justifyContent: 'center', alignItems: 'center'}}>
							<FontAwesome5 name="camera" size={35} color="black" />
						</TouchableOpacity>
					</View>
				</Container>
				:
				<Preview imagen = {imagen} aceptarFotos = {_aceptarFotos.bind(this)} cancelarFoto = {_cancelarFoto.bind(this)}/>
			}
		</View>
	)
}
