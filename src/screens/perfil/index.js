...
import { Alert, View, Text, TouchableOpacity, ImageBackground, ActivityIndicator, Pressable } from 'react-native'
    ...
    <View style={{ flex: 1, position: 'relative' }}>
      ...
      >
        <View style={styles.userData}>
          <Text allowFontScaling={false} style={{ fontSize: 18, color: '#B29360', fontWeight: 'bold' }}>
            ...
            <View className="gap-2">
              {user.Propietario && (
                ...
                >
                  {loading ? (
                    ...
                    <Text className="text-white text-center text-base"> {i18n.t('profile.users')}</Text>
                  )}
                </TouchableOpacity>
              )}
              <TouchableOpacity
              ...
              >
                {loading ? (
                  ...
                  <Text className="text-white text-center text-base"> {i18n.t('profile.logout')}</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
