                  ...
                  <ScrollView>
                     ...
                     <View style={Styles.lista}>
                        ...
                        <Text style={Styles.listaText}>
                           &nbsp;
                           {info.FechaVisita
                              ? moment(info.FechaVisita).format(
                                   "DD/MM/YYYY HH:mm"
                                )
                              : "Sin fecha asignada"}
                        </Text>
         ...
         <View style={Styles.backGround}>
            <Container>
               <ScrollView style={{flex: 1}}>
                  ...
                  <Text
                     style={{textAlign: "center", color: Colores.DetalleText}}
                  >
