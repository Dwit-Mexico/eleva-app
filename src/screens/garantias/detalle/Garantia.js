          ...
          <View className="flex-1 p-4">
            <ScrollView>
              ...
              <View style={Styles.comentarios}>
                <Text style={{ fontSize: 16, color: '#000' }}>{info.ComentariosAplica}</Text>
              </View>
        ...
        <View className="flex-1 bg-[#000000A1]">
          <View className="flex-1 p-4">
            <ScrollView>
              ...
              >
                Fecha Visita:{' '}
                {info.FechaVisita ? moment.utc(info.FechaVisita).format('DD/MM/YYYY HH:mm') : 'Sin fecha asignada'}
              </Text>
            ...
            <ScrollView>
              ...
              >
                <View style={Styles.imagenesContent}>
                  <ImagenButton
                    index={1}
                    imagen={info.ImgEvidencia1 ? { uri: info.ImgEvidencia1 } : null}
                    navigation={navigation}
                  />
                  <ImagenButton
                    index={2}
                    imagen={info.ImgEvidencia2 ? { uri: info.ImgEvidencia2 } : null}
                    navigation={navigation}
                  />
                  <ImagenButton
                    index={3}
                    imagen={info.ImgEvidencia3 ? { uri: info.ImgEvidencia3 } : null}
                    navigation={navigation}
                  />
                </View>
              </View>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                <BotonAccion onPress={aceptarRealizado.bind(this)} loading={loading}>
                  <Text style={{ fontSize: 18, color: 'white' }}>{i18n.t('button.send')}</Text>
                </BotonAccion>
              </View>
      ...
      <View className="flex-1 bg-[#000000A1]">
        <View className="flex-1 p-4">
          <ScrollView style={{ flex: 1 }}>
            ...
            <Text style={{ textAlign: 'center', color: Colores.DetalleText }}>{i18n.t('status.title')}</Text>
